...
export function Project({ title, description, tags, imageUrl }: ProjectProps) {
  ...
  return (
    ...
    border-black/5 rounded-lg overflow-hidden sm:pr-8 relative 
    sm:h-[20rem] mb-3 hover:bg-gray-200 sm:group-even:pl-8
     transition dark:bg-white/10 dark:hover:bg-white/20 dark:text-white"
      >
        <div
